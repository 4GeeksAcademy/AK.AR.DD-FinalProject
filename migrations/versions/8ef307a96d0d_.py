...
Revision ID: 8ef307a96d0d
Revises: 
Create Date: 2023-07-12 20:39:57.208720
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['ciudad'], ['city.name'], ),
    sa.ForeignKeyConstraint(['username'], ['user.email'], ),
    sa.PrimaryKeyConstraint('id')
    )
