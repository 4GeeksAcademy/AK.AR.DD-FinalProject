              ...
              <div className="card-body cityinfo">
                ...
                <div className="botones-ciudad">
                  ...
                  {/* <button
                    ...
                    onClick={() => handleGoToCommentFeed(city.name)}
                  >
                    Go to review section
                  </button> */}
                  <div>
                    <FontAwesomeIcon className="comment" icon={faComment} onClick={() => handleGoToCommentFeed(city.name)} />
